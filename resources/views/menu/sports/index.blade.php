...
@section('title', 'Sports - NOCIS')
@section('page-title')
    Sports <span class="bg-red-500 text-white text-sm px-2 py-1 rounded-full ml-2">Admin</span>
@endsection
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800">All Sports</h3>
        </div>
                    ...
                    @forelse ($sports as $sport)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $sport->code }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="text-gray-500">
                                    ...
                                    <p class="text-sm">Create your first sport to get started</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
...
<script>
    ...
    function checkUrlFlashMessages() {
        ...
        if (flash === 'created' && name) {
            ...
            showFlashMessage(`Sport "${name}" updated successfully!`, 'status');
            // Remove parameters from URL and refresh page
            setTimeout(() => {
                const newUrl = window.location.pathname;
                window.history.replaceState({}, document.title, newUrl);
