...
@section('title', 'Create Sport - NOCIS')
@section('page-title')
    Create Sport <span class="bg-red-500 text-white text-sm px-2 py-1 rounded-full ml-2">Admin</span>
@endsection
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Create New Sport</h2>
            <p class="text-gray-600 mt-1">Add a new sport discipline to the system</p>
        </div>
        <a href="{{ route('admin.sports.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg flex items-center">
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <form action="{{ route('admin.sports.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i> Create Sport
                </button>
            </div>
        </form>
    </div>
